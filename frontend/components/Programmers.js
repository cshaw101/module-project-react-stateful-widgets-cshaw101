...
export default function Programmers() {
  ...
  let [listOfProgrammers, setListOfProgrammers] = useState(listOfAwesome)
  let [activeProgrammer, setActiveProgrammer] = useState(null)
  ...
  const getNameOfFeatured = () => {
    ...
    const featuredDev = listOfProgrammers.find(dev => dev.id === activeProgrammer)
